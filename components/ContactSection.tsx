...
export default function ContactSection() {
  return (
    <section id="contact" className="px-4 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl overflow-hidden rounded-[2rem] px-6 py-12 text-white shadow-2xl sm:px-10 lg:grid lg:grid-cols-[1fr_0.9fr] lg:gap-10 lg:py-16" style={{ background: 'linear-gradient(135deg, #A61E1E 0%, #D62828 50%, #F77F00 100%)' }}>
          <div>
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              <div className="rounded-[1.5rem] bg-white/10 p-5 backdrop-blur">
                ...
                <p className="text-lg font-bold">08068052368</p>
                <p className="text-lg font-bold">08132555123</p>
              </div>
              <div className="rounded-[1.5rem] bg-white/10 p-5 backdrop-blur">
                <p className="text-sm font-semibold uppercase tracking-[0.2em] text-white/70">Address</p>
                <p className="mt-2 text-lg font-bold">Morounranti Complex, Bodija, Ibadan</p>
              </div>
            </div>
          </div>
